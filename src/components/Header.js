    ...
    return (
        ...
        <div className="grid grid-flow-col m-4 ">
            <div className="col-span-1 flex">
                ...
                alt="sidebar icon" />
                <img className="h-20 -my-4 padding-left-20" src="https://cdn.mos.cms.futurecdn.net/8gzcr6RpGStvZFA2qRt4v6-1200-80.jpg" alt="youtube logo" />
            </div>
            ...
            <img className = "h-12" src="https://icons.veryicon.com/png/o/internet--web/prejudice/user-128.png" alt="user info icon"/>
            </div>
        </div>
    )
}
